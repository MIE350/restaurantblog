...
public class Restaurant {
    ...
    public void setReviewsList(ReviewList reviewsList){
    ...
    // Methods
	public void readData(String address, String cuisine, String hoursOperation, int id, String name, String pictures, String price, double rating, ReviewList reviewsList, String website) {
			this.address = name;
			this.cuisine = cuisine;
            this.hoursOperation = hoursOperation;
            this.id = id;
