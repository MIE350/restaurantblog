...
public class StudentList {
	...
	public boolean insert(Student student) {
		...
		String qStr = "INSERT INTO Student Values ('" + stid + "', '" + lname + "', '"+ fname + "', '"  + stemail + "', '" +
